...
import business.TypeReservation;

public class FileStorage {

	
	//append the data to the end of the file
	public void appendResevationDTO(String data, String fileName) throws UnsupportedEncodingException{
	...
	//return the list of url for the specific topic
		...
		public List<Service> readAllServices(String fileName) throws UnsupportedEncodingException{
			String fullPath = URLDecoder.decode(fileName, "UTF-8");
			...
			try {
				...
				while(line != null){
					int endTopicIndex = line.indexOf("-");
						result.add(new Service(TypeReservation.of(line.substring(0,endTopicIndex)),line.substring(endTopicIndex+1,line.length())));
					line = br.readLine();
				}
				br.close();
				return result;
